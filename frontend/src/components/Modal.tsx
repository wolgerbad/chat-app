...
export default function Modal() {
  ...
  return (
    <div className="fixed inset-0 backdrop-blur-xs backdrop-brightness-50">
      <div className="flex flex-col fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-black-500 bg-white rounded-md md:w-96">
        ...
        <div className="px-4 flex-1 mb-8">
          <div className="flex items-center gap-2 mb-2">
            ...
            <input
              type="text"
              className="border-1 outline-none px-2 py-1 w-full"
              value={clientName}
          ...
          <div className="flex gap-2 items-center">
            ...
            <input
              type="text"
              className="border-1 outline-none px-2 py-1 bg-gray-400 cursor-not-allowed w-full"
              value={user.email}
              readOnly
            />
          </div>
